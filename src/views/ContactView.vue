...
function validateForm() {
  ...
  subjectElement.setCustomValidity(
    subjectElement.checkValidity() ? '' : 'Please enter your subject'
  )
  messageElement.setCustomValidity(
    messageElement.checkValidity() ? '' : 'Please enter your message'
  )
...
<template style="background-color: red">
  <VHeroBlock
    imageUrl="./src/assets/hero_contact.png"
    title="Contact Us"
    optionalClass="pr-contact-hero"
  />
  <div class="overlap-box">
    <div class="px-24 py-12">
      <span class="pr-contact-title-1 text-2xl font-bold text-gray-800">Request </span
      ><span class="pr-contact-title-2 text-2xl font-bold text-blue-500">a quote</span>
    </div>
    <div class="form-title-underline"></div>
    <div class="pr-form-category">By phone</div>
    <div class="pr-text-up">
      <FontAwesomeIcon :icon="faPhone" class="pr-icon-footer" /><a href="tel:+13039154272"
        >+1 303 915-4272</a
      >
    </div>
    <div class="pr-form-category">By email</div>
